...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Create New pelanggan</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/pelanggan') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
